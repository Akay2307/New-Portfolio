...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      {/* Premium Background */}
      <div className="absolute inset-0 -z-10 animate-[slowZoom_30s_ease-in-out_infinite]">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(32,178,166,0.25),transparent_60%)]" />
      ...
      <div className="container mx-auto px-6 pt-32 pb-20 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center md:block">
            <div className="relative w-64 sm:w-72 md:max-w-md mx-auto">
          ...
          <div className="relative overflow-hidden">
            ...
            <div className="flex animate-marquee">
              {[...skills, ...skills].map((skill, idx) => (
                <div
                  key={idx}
                  className="shrink-0 px-8 py-3 border-r border-border"
                >
