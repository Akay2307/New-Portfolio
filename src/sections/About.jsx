      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-3 sm:space-y-4 text-sm sm:text-base md:text-base text-muted-foreground animate-fade-in animation-delay-200">
              <p>
                I'm a passionate Fullstack Developer with 2 years of
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 md:gap-6">
            {highlights.map((item, idx) => (
              <div
                key={idx}
                className="glass p-4 sm:p-5 md:p-6 rounded-2xl animate-fade-in"
                style={{ animationDelay: `${(idx + 1) * 100}ms` }}
              >
                <div className="w-10 sm:w-12 h-10 sm:h-12 rounded-xl bg-primary/10 flex items-center justify-center mb-3 sm:mb-4 hover:bg-primary/20">
