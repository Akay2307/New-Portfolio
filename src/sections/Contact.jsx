    ...
    <section id="contact" className="py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mt-4 mb-4 sm:mb-6 animate-fade-in animation-delay-100 text-secondary-foreground">
            Let's build{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 max-w-5xl mx-auto">
          <div className="glass p-4 sm:p-6 md:p-8 rounded-3xl border border-primary/30 animate-fade-in animation-delay-300">
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm bg-surface rounded-xl border border-border focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm bg-surface rounded-xl border border-border focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all resize-none"
                />
              </div>
          ...
          <div className="space-y-4 sm:space-y-6 animate-fade-in animation-delay-400">
            ...
            <div className="glass rounded-3xl p-4 sm:p-6 md:p-8 border border-primary/30">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-sm sm:text-base font-medium">Currently Available</span>
              </div>
